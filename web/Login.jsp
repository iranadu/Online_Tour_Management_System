<%-- 
    Document   : Login
    Created on : Feb 28, 2015, 8:15:40 PM
    Author     : OOPs
--%>
  ...
  <div class="container">
    <div class="login">
      ...
      <div  style="">
          ...
          <a href="http://localhost:8084/indiatours/Registeration.jsp" class="button" style="width: 100px; height: 40px; padding-top: 15px; color: #ffffff;" >New USer</a>
    </div>
  </div>
 </div>   
